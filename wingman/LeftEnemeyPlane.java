...
/**
 * This class LeftEnemeyPlane is a subclass of Plane.
 * This is a plane that faces horizontally left and moves in this left direction.
 * @author thapaliya
 *
 */
public class LeftEnemeyPlane extends Plane
{
    private int shootingSpeed;
	private int fireSpeedX, fireSpeedY;
	
	public LeftEnemeyPlane()
	{
	   this.speed=3;
	...
	public void draw(Graphics2D g, ImageObserver imageObs, GameObject o1, GameObject o2) 
	{
		...
		{
			shoot(); drawBullets(g, imageObs, (PlayerPlane)o1, (PlayerPlane)o2);
		}
