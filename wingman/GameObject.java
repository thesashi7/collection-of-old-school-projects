...
public abstract class GameObject 
{
	...
	/**
	 * Sets the second image or sprite of this object using the name of the file.
	 * @param img
	 */
	/*public void setSprite1(Image img)
	{
		this.objectImage1= img;
		//this.obImage.add(img);
	}*/
	
	/**
	 * Sets the third image or sprite of this object using the name of the file.
	 * @param img
	 */
	/*public void setSprite2(Image img)
	{
		this.objectImage2= img;
	}*/
	...
	{
		//this.objectImage= getSprite(name);
	 ...
	 * @param img
	 */
	/*public void setSprite2(String name)
	{
		this.objectImage1= getSprite(name);
	}*/
	 ...
	 * @param img
	 */
	/*public void setSprite3(String name)
	{
		this.objectImage2= getSprite(name);
	}
	*/
	/**
	...
	public void draw(Graphics2D g, ImageObserver imageObs)
	{
     ...
     protected Image getSprite(String name) 
	 {
		   Image img=null;
