...
/**
 * This class RightEnemeyPlane is a subclass of Plane.
 * This is a plane that faces horizontally right and moves in this right direction.
 * @author thapaliya
 *
 */
public class RightEnemyPlane extends Plane
{
    private int shootingSpeed;
	private int fireSpeedX, fireSpeedY;
    
	public RightEnemyPlane()
	{
		this.speed=3;
