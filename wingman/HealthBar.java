 ...
 * of the number of the images or sprites in the HealthBar or else there is no guarantee that this healthbar will work well.
 * @author thapaliya
 *
 */
public class HealthBar extends GameObject
{
	...
	public void setHealthForHB(int h)
	{
		...
		//this.setPosition(ap.getWidth()-, b)
	}
